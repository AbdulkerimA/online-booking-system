...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($_POST['depFrom'] && $_POST['destination'] &&
        ...
        $controllObj->generateTickets($depFrom, $destination, $planeId, $depDate, $returnDate,
         $numofTickets, $price, "international");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Generate tickets for international flights</h1>
                    </div>
                    <span id=<?php $error == "successfuly generated"? print"noerror" : print "error" ?> > 
                        <?php echo $error; ?>
                    </span>
                    <form action="./international.php" method="post" id="generate">
